...
import '../../presentation/proprietaires/pages/complaint_screens/complaint_tracking_controller.dart';
import '../../presentation/proprietaires/pages/complaint_screens/complaint_tracking_state.dart';
...
// Use Cases des Plaintes (dépendent de PlainteRepository)
...
final getOwnerComplaintsUseCaseProvider = Provider((ref) {
  return GetOwnerComplaintsUseCase(ref.watch(plainteRepositoryProvider));
});
...
// Provider pour le contrôleur de gestion des plaintes
final complaintTrackingControllerProvider =
    StateNotifierProvider<ComplaintTrackingController, ComplaintTrackingState>(
        (ref) {
  return ComplaintTrackingController(
    getComplaintsUseCase: ref.watch(getOwnerComplaintsUseCaseProvider),
    updateStatusUseCase: ref.watch(updateComplaintStatusUseCaseProvider),
  );
});
